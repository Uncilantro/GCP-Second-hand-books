...
const _sfc_main = {
    ...
    common_vendor.index.request({
      ...
      success: (res) => {
        ...
        if (qitaCollege) {
          ...
          common_vendor.index.__f__("log", "at pages/qita/qita.vue:71", "college:", this.college);
          common_vendor.index.__f__("log", "at pages/qita/qita.vue:72", "allItems:", this.allItems);
        } else {
          common_vendor.index.__f__("error", "at pages/qita/qita.vue:74", "其他学院数据未找到");
        }
      },
      fail: () => {
  ...
  onLoad() {
    ...
    common_vendor.index.__f__("log", "at pages/qita/qita.vue:96", "窗口高度:", this.wh);
  }
};
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/qita/qita.js.map
