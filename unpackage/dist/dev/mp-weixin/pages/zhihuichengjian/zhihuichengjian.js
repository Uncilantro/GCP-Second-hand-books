...
const _sfc_main = {
    ...
    common_vendor.index.request({
      ...
      success: (res) => {
        ...
        if (zhihuichengjianCollege) {
          ...
          common_vendor.index.__f__("log", "at pages/zhihuichengjian/zhihuichengjian.vue:71", "college:", this.college);
          common_vendor.index.__f__("log", "at pages/zhihuichengjian/zhihuichengjian.vue:72", "allItems:", this.allItems);
        } else {
          common_vendor.index.__f__("error", "at pages/zhihuichengjian/zhihuichengjian.vue:74", "智慧城建学院数据未找到");
        }
      },
      fail: () => {
  ...
  onLoad() {
    ...
    common_vendor.index.__f__("log", "at pages/zhihuichengjian/zhihuichengjian.vue:96", "窗口高度:", this.wh);
  }
};
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/zhihuichengjian/zhihuichengjian.js.map
