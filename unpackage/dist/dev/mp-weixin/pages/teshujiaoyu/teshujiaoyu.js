...
const _sfc_main = {
    ...
    common_vendor.index.request({
      ...
      success: (res) => {
        ...
        if (teshujiaoyuCollege) {
          ...
          common_vendor.index.__f__("log", "at pages/teshujiaoyu/teshujiaoyu.vue:71", "college:", this.college);
          common_vendor.index.__f__("log", "at pages/teshujiaoyu/teshujiaoyu.vue:72", "allItems:", this.allItems);
        } else {
          common_vendor.index.__f__("error", "at pages/teshujiaoyu/teshujiaoyu.vue:74", "特殊教育学院数据未找到");
        }
      },
      fail: () => {
  ...
  onLoad() {
    ...
    common_vendor.index.__f__("log", "at pages/teshujiaoyu/teshujiaoyu.vue:96", "窗口高度:", this.wh);
  }
};
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/teshujiaoyu/teshujiaoyu.js.map
